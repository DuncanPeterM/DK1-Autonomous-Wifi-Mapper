...
public class VirtualStickView extends RelativeLayout
    ...
    private void setUpListeners() {
        ...
        screenJoystickRight.setJoystickListener(new OnScreenJoystickListener() {
            ...
            @Override
            public void onTouch(OnScreenJoystick joystick, float pX, float pY) {                                //drone control area
                if (Math.abs(pX) < 0.02) {
                    pX = 0;
                }
                ...
                float yawJoyControlMaxSpeed = 100;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_yaw_control_mode:                                                            //Control modes set here
